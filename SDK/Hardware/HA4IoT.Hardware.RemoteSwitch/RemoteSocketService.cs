...
namespace HA4IoT.Hardware.RemoteSwitch
{
    public class RemoteSocketService : ServiceBase, IBinaryOutputController
    {
        ...
        public RemoteSocketService(LPD433MHzSignalSender sender, ISchedulerService schedulerService)
        {
        ...
        public RemoteSocketService WithRemoteSocket(int id, LPD433MHzCodeSequencePair codeSequencePair)
        {
