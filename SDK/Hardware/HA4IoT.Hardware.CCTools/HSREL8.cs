...
namespace HA4IoT.Hardware.CCTools
{
    ...
    {
        public HSREL8(DeviceId id, I2CSlaveAddress i2CAddress, II2CBus i2CBus, IApiController apiController, ILogger logger)
            : base(id, new MAX7311Driver(i2CAddress, i2CBus), apiController, logger)
        {
