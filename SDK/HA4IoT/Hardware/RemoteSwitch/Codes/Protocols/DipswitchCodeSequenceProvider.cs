...
{
    public class DipswitchCodeSequenceProvider
    {
        public Lpd433MhzCodeSequencePair GetSequencePair(DipswitchSystemCode systemCode, DipswitchUnitCode unitCode)
        {
        ...
        public Lpd433MhzCodeSequence GetSequence(DipswitchSystemCode systemCode, DipswitchUnitCode unitCode, RemoteSocketCommand command)
        {
            // Examples:
            // System Code = 11111
