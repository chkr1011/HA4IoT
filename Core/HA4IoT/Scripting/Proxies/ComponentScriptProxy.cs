...
{
    public class ComponentScriptProxy : IScriptProxy
    {
        private readonly IScriptingSession _scriptingSession;
        private readonly IComponentRegistryService _componentRegistry;

        [MoonSharpHidden]
        public ComponentScriptProxy(IComponentRegistryService componentRegistry, IScriptingSession scriptingSession)
        {
