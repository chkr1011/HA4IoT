...
namespace HA4IoT.Controller.Main.Rooms
{
    internal class ReadingRoomConfiguration : RoomConfiguration
    {
        ...
        public ReadingRoomConfiguration(IController controller, CCToolsBoardController ccToolsBoardController, RemoteSocketController remoteSocketController) 
        ...
        {
            var hsrel5 = CCToolsBoardController.CreateHSREL5(Device.ReadingRoomHSREL5, new I2CSlaveAddress(62));
